...
import {View, Text, Alert, KeyboardAvoidingView, ScrollView, TouchableOpacity, Modal} from 'react-native';
...
export default class WelcomeScreen extends Component{
    ...
    userSignup= (emailId,password, confirmPassword)=>{
        if(password !== confirmPassword){
            ...
            firbase.auth().createUserWithEmailAndPassword(emailId,password)
            .then(()=>{
                ...
                return Alert.alert("User added successfully",' ',[{text: 'ok', 
                onPress:()=>this.setState({"isModalVisible": false})
            }])
            .catch((error)=>{
